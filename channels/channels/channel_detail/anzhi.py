...
def get_anzhi_detail(response):
    ...
    app_name = html.xpath('//span[@class="app_detail_version"]/../h3/text()').extract()[0]
    ...
    app_download_times = html.xpath('//ul[@id="detail_line_ul"]/li[2]/span/text()').extract()[0].split(u'：')[1]
